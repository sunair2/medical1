...
from utils.beautify import (BASE_FONT_PATH, TEXT_COLOR, BASE_LINE_WIDTH,
                            calculate_beautify_params)
...
def parse_args():
    ...
    parser.add_argument("--weights", type=str,
            default=r"C:\Users\14854\Desktop\BTD\yoloserver\models\checkpoints\train_20250701-110112_yolo12n_best.pt", help="模型权重信息路径")
    parser.add_argument("--source", type=str,
            default=r"C:\Users\14854\Desktop\BTD\yoloserver\data\test\images", help="推理数据源")
