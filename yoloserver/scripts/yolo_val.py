...
def parse_args():
    ...
    parser.add_argument("--weights", type=str, default="train_20250701-110112_yolo12n_best.pt", help="预训练模型路径")
...
def main():
    ...
    try:
        # 加载配置
        yaml_config = load_config(config_type='val') if args.use_yaml else {}
        ...
        # 添加回调
        model.add_callback(event="on_train_end", func=add_save_dir_train)
        model.add_callback(event="on_val_end", func=add_save_dir_val)
