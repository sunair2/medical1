...
DEFAULT_BEAUTIFY_PARAMS = {
    ...
    "font_path": r"LXGWWenKai-Bold.ttf", # <<=== 提醒：请确保这里指向你的字体文件路径
    "font_size": 26,
    "line_width": 4,
    "label_padding_x": 10,
    "label_padding_y": 10,
...
if __name__ == '__main__':
    ...
    # --- 3. 加载 YOLO 模型 ---
    model_path_full = CHECKPOINT_DIR / test_model_name
    yolo_model = load_yolo_model(model_path=model_path_full, device=test_device)

    # --- 4. 准备一张测试图片 ---
    # 请在这里提供你的测试图片路径！
    # 示例路径，请替换为你的实际图片路径
    test_image_path = "C:\\Users\\Matri\\Desktop\\DTH2\\yoloserver\\data\\test\\images\\G_4_jpg.rf.003b525a8ad0715df867bc4214c7bf1c.jpg"
